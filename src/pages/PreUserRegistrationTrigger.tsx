...
export default function PreUserRegistrationTrigger() {
    ...
    <div className="min-h-screen bg-white w-screen p-0">
      ...
      <div className="flex items-center justify-between px-12 pt-10 pb-6">
        <div>
          ...
          <h1 className="text-3xl font-bold mb-1">Pre User Registration</h1>
          <div className="text-gray-500 text-base">Customize the registration trigger for your applications.</div>
        </div>
          ...
          <div className="relative z-10 flex flex-col items-center mt-24">
            ...
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center border-4 border-white shadow-lg">
                <svg width="32" height="32" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4" stroke="#fff" strokeWidth="2"/><path d="M6 20c0-2.21 3.582-4 6-4s6 1.79 6 4" stroke="#fff" strokeWidth="2"/></svg>
              </div>
              <div className="text-lg font-semibold mt-2">Start</div>
              <div className="text-gray-400 text-sm">User signup</div>
            </div>
            {/* Arrow */}
            ...
            <div className="flex flex-col items-center group">
              ...
              <div className="text-gray-400 text-sm">User registered</div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-gray-400 text-sm">
            {tab==='installed' ? (
              <>
                ...
                <button className="text-blue-700 underline mt-1" onClick={()=>setShowModal(true)}>Install Action</button>
              </>
            ) : (
              <>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 relative">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <select className="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100" value="Pre User Registration" disabled>
                  <option>Pre User Registration</option>
                </select>
              </div>
              <div>
