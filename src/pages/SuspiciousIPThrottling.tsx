...
export default function SuspiciousIPThrottling() {
    ...
    <div className="min-h-screen bg-white w-screen p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-2">
          <h1 className="text-3xl font-bold">Suspicious IP Throttling</h1>
          <span className="bg-green-100 text-green-700 font-semibold px-3 py-1 rounded text-xs">ENABLED</span>
        </div>
        <div className="text-gray-600 mb-6">Protect your accounts against high-velocity attacks that target multiple user accounts from a single IP address.</div>
        <div className="mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row gap-8 mb-4">
            <div className="flex-1">
              <div className="font-semibold mb-1">Suspicious IP Thresholds</div>
              <div className="text-gray-500 text-sm mb-2">Manage the number of incorrect login and sign up attempts allowed from a single IP address before attack mitigation steps are taken. <a href="#" className="text-blue-700 underline">Learn more</a></div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row gap-8">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mb-2">
                <span>Limit high-velocity traffic targeting too many accounts</span>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mb-2">
                <span>Send notifications to the account administrator</span>
                <span className="ml-auto inline-flex items-center"><span className="w-8 h-5 bg-green-200 rounded-full relative"><span className="inline-block w-4 h-4 bg-green-500 rounded-full absolute left-4 top-0.5 shadow" /></span></span>
              </div>
            </div>
          </div>
