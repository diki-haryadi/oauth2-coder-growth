...
export default function PostUserRegistrationTrigger() {
    ...
    <div className="min-h-screen bg-white w-screen p-0">
      ...
      <div className="flex items-center justify-between px-12 pt-10 pb-6">
        <div>
          ...
          <h1 className="text-3xl font-bold mb-1">Post User Registration</h1>
          <div className="text-gray-500 text-base">Customize the trigger after a new user has been created in the database.</div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 relative">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <select className="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100" value="Post User Registration" disabled>
                  <option>Post User Registration</option>
                </select>
              </div>
              <div>
