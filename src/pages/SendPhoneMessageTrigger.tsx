...
export default function SendPhoneMessageTrigger() {
    ...
    <div className="min-h-screen bg-white w-screen p-0">
      ...
      <div className="flex items-center justify-between px-12 pt-10 pb-6">
        <div>
          ...
          <h1 className="text-3xl font-bold mb-1">Send Phone Message</h1>
          <div className="text-gray-500 text-base">Customize the trigger for sending phone messages (MFA or custom provider).</div>
        </div>
        ...
        <div className="flex-1 bg-gray-50 rounded-2xl border border-gray-100 flex flex-col items-center justify-center min-h-[600px] relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center mt-24">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-gray-400 text-sm">Phone message requested</div>
            </div>
            {/* Arrow */}
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 relative">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <select className="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100" value="Send Phone Message" disabled>
                  <option>Send Phone Message</option>
                </select>
              </div>
              <div>
